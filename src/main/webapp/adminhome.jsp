...
<body class="bg-white">
	...
	if (atoken != null) {
	%>
	<nav class="p-0 m-0 navbar navbar-expand-lg bg-body-tertiary sticky-top shadow-sm">
		<div class="container-fluid">
	
			<h1 class="navbar-brand">
				<img alt="loading" width="50px" src="./in-img/logo.png">
				Hello <%=atoken%></h1>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class=" ms-3 nav-item"
						style="position: absolute; right: 1rem;"><a
...
<section class="container mt-5">
	...
	<table class="table table-light table-hover table-bordered border-info caption-top">
